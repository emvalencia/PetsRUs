        ...
        <div class="row">
            <div class="col-lg-12 px-0">
                <div style="text-align: center;">
                    <img src="../../assets/cat-cover.jpg" alt="cat-cover-photo" class="cover-img"/>
                    <div class="transparent-box">Cats
                    </div>
                </div>
            </div>
        </div>         
            ...
            <table class="table table-light">
                ...
                <tbody>
                    <?php
                        ...
                        $pdo = connect();
                        $data = $pdo->query("select * from product where id >= 1000000001 and id < 1000000004;")->fetchAll();
                        $len = count($data);

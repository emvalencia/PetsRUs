  ...
  <body>
    ...
    <div class="container-fluid">
        ...
        <?php
            ...
            $pdo = connect();
            $data = $pdo->query("select * from product where id = 1000000003;")->fetchAll();
            foreach ($data as $row) {
            }
                ...
                <form name="submit-order-form" class="needs-validation" novalidate id="main-order-form">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <label id="product-id-num" for="product-identifier">1000000003</label>
                        </div>
